...
$app->group(["prefix" => "/admin", "middleware" => "admin"], function (\Vatts\Router\Router $router) {
    ...
    // API Tokens CRUD
    // ==========================================
    $router->get("/tokens", [\App\controllers\Admin\TokensController::class, 'viewAll']);
    $router->get("/tokens/create", [\App\controllers\Admin\TokensController::class, 'viewCreate']);
    $router->post("/tokens/create", [\App\controllers\Admin\TokensController::class, 'create']);
    $router->get("/tokens/[id]/edit", [\App\controllers\Admin\TokensController::class, 'viewEdit']);
    $router->post("/tokens/[id]/edit", [\App\controllers\Admin\TokensController::class, 'edit']);
    $router->get('/tokens/[id]/delete', [\App\controllers\Admin\TokensController::class, 'delete']);

    // ==========================================
    // Database Hosts CRUD
    // ==========================================
    $router->get("/database-hosts", [\App\controllers\Admin\DatabaseHostsController::class, 'viewAll']);
    $router->get("/database-hosts/create", [\App\controllers\Admin\DatabaseHostsController::class, 'viewCreate']);
    $router->post("/database-hosts/create", [\App\controllers\Admin\DatabaseHostsController::class, 'create']);
    $router->get("/database-hosts/[id]/edit", [\App\controllers\Admin\DatabaseHostsController::class, 'viewEdit']);
    $router->post("/database-hosts/[id]/edit", [\App\controllers\Admin\DatabaseHostsController::class, 'edit']);
    $router->get('/database-hosts/[id]/delete', [\App\controllers\Admin\DatabaseHostsController::class, 'delete']);
