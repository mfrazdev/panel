...
@section('content')
    <div class="flex flex-col items-center justify-center min-h-[65vh] animate-[fadeIn_0.3s_ease-out]">
        <div class="w-full max-w-md bg-cards rounded-md shadow-2xl p-10 flex flex-col items-center text-center relative overflow-hidden">


            <!-- Ícone -->
            <div class="w-20 h-20 rounded-2xl bg-terciary flex items-center justify-center text-gray-500 mb-6 shadow-inner relative z-10">
                <svg width="36" height="36" fill="none" stroke="currentColor" color="var(--color-danger)" stroke-width="1.5" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
            ...
            <!-- Botão de Ação -->
            <a href="/admin{{ $backTo ?? '/users' }}" class="w-full bg-info hover:bg-info/[0.03] text-(--color-text-label)  px-8 py-3.5 rounded-md text-sm font-bold transition-all flex items-center justify-center gap-3 relative z-10 group">
